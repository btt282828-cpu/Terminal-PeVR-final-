...
EXTRA = ["JETS","SMH","KRE","XBI","GDX","IGV","SOXX","ITB","KWEB","GRID","PAVE","FIW","CGW","HYDR",
         "XRT","XOP","OIH","ARKF","ARKK","CIBR","SKYY","BOTZ","TAN","ICLN","FAN","XME","SIL","SLV","EWJ","INDA","EWZ","VGK","IBIT","DRIV","EWY","MOO","QTUM","ARKX"]   # ...+ infraestructura de IA: red eléctrica (GRID), construcción (PAVE), agua EE.UU. (FIW), global (CGW) e hidrógeno (HYDR) + Bitcoin (IBIT) + espacio (ARKX)
SATELLITES = ["IWM","TLT","GLD","HYG","UUP","LQD","EMB","RSP"]     # para riesgo y regimen macro (+crédito IG/emergente y S&P equiponderado para los sintéticos de pulso)
...
GRUPO_SECTORES = SECTORS + ["IWM","RSP"]                             # 11 basicos + small caps + S&P equiponderado (amplitud)
GRUPO_SUBSECTORES = ["XBI","KRE","JETS","ITB","ITA","XRT","XOP","OIH","ARKX"]          # temas EE.UU. no-IA (biotech, banca regional, viajes, vivienda, defensa, espacio)
...
EXPLOSIVO_TIPO = {
    ...
    "ARKX": "espacio", "SIL": "plata mineras",
